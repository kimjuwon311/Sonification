...
~~사실 이 ReadMe는 망했습니다. 3분 이상 쳐다보면 당신에게 무슨 일이 발생할 지 모르니 당장 읽기를 멈추십시오.~~
## 모델임? 모델임?색을 들을 수 있게 하는 모델임. 빨간색의 소리는 어떠한가... 가...  되는 것처럼 보일 수도 있지만, 사실 소니피케이션은 NASA에서도 그렇고 시각적인 자료를 쉽게 이해하기 힘들 때 생각보다 많이 사용한다고 함.
